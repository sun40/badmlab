...
$lang = array_merge($lang, array(
	...
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'		=> 'После указанного количества неудачных попыток входа на форум пользователь должен будет дополнительно пройти проверку средством против спам-ботов.',
